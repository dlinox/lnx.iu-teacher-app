  ...
  <v-app app>
    ...
    >
      <v-card elevation="0" class="rounded-0" color="primary" variant="tonal">
        <v-card-item class="text-center" @click="router.push('/')">
          <img
    ...
    <v-main app class="h-100">
      <v-toolbar class="bg-white px-4 border-b" app>
        <v-avatar class="ms-4 rounded-0" size="40" @click="$router.push('/')">
      ...
      <v-card class="rounded-0 bg-white" elevation="0">
        <v-container class="pb-0">
          <v-card-title>
            <h3 class="text-md-h3 text-md-h4 text-h5 text-primary">
              {{ headingStore?.title }}
            </h3>
          </v-card-title>
          ...
          <v-tabs class="mt-2 d-none d-md-flex">
            <v-tab value="Dashboard" link exact :to="{ name: 'Dashboard' }">
              Inicio</v-tab
            >
            <v-tab value="Groups" link exact :to="{ name: 'GroupsView' }">
              Grupos
            </v-tab>
            <!-- 
